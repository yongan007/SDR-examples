...
Handler_Simulation.PreprocessingHandlersArray = {Handler_Desired_State, Handler_State_StateSpace, Handler_Desired_State_StateSpace, ...
    Handler_dynamics_GC_model_evaluator, Handler_dynamics_Linear_model_evaluator};
Handler_Simulation.ControllerArray = {Handler_InverseDynamics, Handler_LQR};
% Handler_Simulation.ControllerArray = {Handler_InverseDynamics, Handler_ComputedTorqueController, Handler_LQR};
