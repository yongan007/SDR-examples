...
LinkArray = SRD_GetLinkArrayFromURDF('UrdfFilePath','../robots_library/hyq/urdf/hyq.urdf','ParseSTL',true);
Color_0 = [1, 0, 0];
...
InitialPosition = [0, 0, 0.9*pi/2, 0, 0, -0.9*pi/2, 0, 0, 0.9*pi/2, 0, 0, -0.9*pi/2]';
