...
ZeroOrderDerivativeNodes = {IC_Task(1), IC_Task(1)+0.07;
                            IC_Task(2), IC_Task(2)+0.07;
                            IC_Task(3), IC_Task(3)+0.07;
                            IC_Task(4), IC_Task(4)+0.07;
                             IC_Task(5), IC_Task(5)+0.07;
                            IC_Task(6), IC_Task(6)+0.07;
                            IC_Task(7), IC_Task(7)+0.005;                           
                            IC_Task(8), IC_Task(8)+0.005;
                            IC_Task(9), IC_Task(9)+0.005;
};
