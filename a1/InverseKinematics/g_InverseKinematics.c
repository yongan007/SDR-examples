...
static const casadi_int casadi_s1[14] = {3, 3, 0, 2, 5, 8, 1, 2, 0, 1, 2, 0, 1, 2};
...
/* g_InverseKinematics_TaskJacobian:(q[3])->(TaskJacobian[3x3,8nz]) */
...
/* g_InverseKinematics_TaskJacobian_derivative:(q[3],v[3])->(TaskJacobian_derivative[3x3,8nz]) */
