...
RightFoot = SRDLinkWithJoint('abs_spherical',  index, 'datafile_RightFoot', RightShin,  2); index = index + 1;
LeftFoot =  SRDLinkWithJoint('abs_spherical',  index, 'datafile_LeftFoot',  LeftShin,   2); index = index + 1;
